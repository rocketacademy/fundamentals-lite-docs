...
Let's run code outside the browser console. We'll create a basic program with a Coding Fundamentals starter template.

## Setup

1. [Download the zipped folder](https://github.com/rocketacademy/fundamentals-starter-code/archive/refs/heads/main.zip) of the Coding Fundamentals Starter template and extract it to an appropriate location in your computer - see the [suggested folder structure](../course-logistics/required-hardware-and-software/recommended-set-up.md).
2. [Open your Fundamentals folder in VSCode](../course-logistics/required-hardware-and-software/recommended-set-up.md).
...
We can also assign variables or even mathematical operations to `myOutputValue`. Our previous code from 2.2: Variables looked like this.
